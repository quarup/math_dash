...
- **Next action — single-currency "coins" economy rework (spec agreed 2026-09-08, ready to implement):** Replace the two-currency 🧱/🔬 economy with one currency, **coins**, where 1 coin ≈ 1 expected-second of study. All decisions below are settled with the user — implement, don't re-litigate; the named constants are tunable defaults.
